...
def load_data():
    ...
    with open("../../Downloads/Object-Oriented-Python-Getters-and-Properties-Source-code/albums.txt", "r") as albums:
        for line in albums:
...
def create_checkfile(artist_list):
    ...
    with open("../../Downloads/Object-Oriented-Python-Getters-and-Properties-Source-code/checkfile.txt", 'w') as checkfile:
